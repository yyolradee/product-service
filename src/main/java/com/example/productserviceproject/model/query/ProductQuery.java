...
public class ProductQuery implements Serializable {
    ...
    public ProductQuery(String _id, String name, String description, String img_path, double price, String category, List<Reviews> reviews, String shop_id, String create_at, String edit_at) {
        this._id = _id;
        this.name = name;
